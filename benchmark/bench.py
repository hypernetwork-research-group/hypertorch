...
# def load_gcn(metrics: MetricCollection, num_nodes: int, num_features: int = 32):
#     # load gcn module and config togheter
#     pass
...
#         list_models = [
#         load_gcn(metrics=metrics, num_nodes=dataset.hdata.num_nodes, num_features=num_features),
#         ]
