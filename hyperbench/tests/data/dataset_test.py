...
def test_Preloaded_dataset_loads_hdata_when_hdata_is_none():
    mock_hdata = MagicMock(spec=HData)
    with patch.object(HIFLoader, "load", return_value=mock_hdata) as mock_load:
...
#     with patch.object(HIFLoader, "load", return_value=mock_hypergraph):
#         hypergraph = HIFLoader.load(dataset_name)
...
# def test_HIFLoader_loads_invalid_dataset():
#     dataset_name = "INVALID_DATASET"

#     with pytest.raises(ValueError, match="Dataset 'INVALID_DATASET' not found"):
#         HIFLoader.load(dataset_name)


# def test_HIFLoader_loads_invalid_hif_format():
#     dataset_name = "ALGEBRA"
...
# def test_HIFLoader_stores_on_disk_when_save_on_disk_true():
#     dataset_name = "ALGEBRA"
...
#         hypergraph = HIFLoader.load(dataset_name, save_on_disk=True)
...
# def test_HIFLoader_uses_temp_file_when_save_on_disk_false():
#     dataset_name = "ALGEBRA"
...
#         hypergraph = HIFLoader.load(dataset_name, save_on_disk=False)
...
# def test_HIFLoader_download_failure():
#     dataset_name = "ALGEBRA"
...
#     with patch.object(HIFLoader, "load", return_value=mock_simple_hypergraph):
#         dataset = AlgebraDataset(sampling_strategy=strategy)
...
# ):
#     with patch.object(HIFLoader, "load", return_value=mock_sample_hypergraph):
#         dataset = AlgebraDataset(sampling_strategy=strategy)
...
#     with patch.object(
#         HIFLoader, "load", return_value=mock_three_node_weighted_hypergraph
#     ):
#         dataset = AlgebraDataset(sampling_strategy=strategy)
