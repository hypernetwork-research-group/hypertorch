...
def test_model_hypergcn(tmp_path, sampling_strategy):
    ...
    multi_model_trainer(configs, path=tmp_path, experiment_name="hypergcn_integration_test")

    assert (tmp_path / "hypergcn_integration_test" / "comparison" / "overall.tex").exists()
    assert (tmp_path / "hypergcn_integration_test" / "comparison" / "test.tex").exists()
    assert (tmp_path / "hypergcn_integration_test" / "comparison" / "results.md").exists()
