...
| [mlp.py](https://github.com/hypernetwork-research-group/hyperbench/blob/main/examples/mlp.py) | MLP HLP pipeline on `AlgebraDataset` (negative sampling + LPE enricher) | `make run examples/mlp.py` |
| [common_neighbors.py](https://github.com/hypernetwork-research-group/hyperbench/blob/main/examples/common_neighbors.py) | Common Neighbors HLP baseline on `AlgebraDataset` (negative sampling) | `make run examples/common_neighbors.py` |
...
| [train_with_checkpoints.py](https://github.com/hypernetwork-research-group/hyperbench/blob/main/examples/train_with_checkpoints.py) | Training with checkpointing and prediction | `make run examples/train_with_checkpoints.py` |
